...
var intentCorpus = []intentCorpusCase{
	...
	{Name: "search-current-room", Message: "search the room", Want: corpusPlan{Actions: []corpusAction{action(intent.ActionInspect, "")}}},
	{Name: "search-named-current-room", Message: "search the storage room", Want: corpusPlan{Actions: []corpusAction{action(intent.ActionInspect, "")}}},
	{Name: "search-both-doctors-explicit", Message: "search the both doctors", Want: corpusPlan{Actions: []corpusAction{{Action: intent.ActionSearch, Target: "doctors", TargetMode: intent.TargetAll}}}},
	...
	{Name: "take-flashlight-polite", Message: "take the flashlight, please", Want: corpusPlan{Actions: []corpusAction{action(intent.ActionTakeItem, "flashlight")}}},
	...
	{Name: "unlock-that-door", Message: "use the key to unlock that door", Want: corpusPlan{Actions: []corpusAction{{Action: intent.ActionUseItem, Target: "door", Item: "key", TargetMode: intent.TargetSingle}}}},
	{Name: "unlock-named-door", Message: "unlock the The Emergency Stairwell Door is locked", Want: corpusPlan{Actions: []corpusAction{{Action: intent.ActionUseItem, Target: "emergency stairwell door", Item: "key", TargetMode: intent.TargetSingle}}}},
	...
	{Name: "select-both-doctors-polite", Message: "both doctors, please", Want: corpusPlan{Actions: []corpusAction{{Action: intent.ActionSearch, Target: "both", TargetMode: intent.TargetAll}}}},
	...
	{Name: "compound-light-search-room", Message: "turn on the flashlight and search the room", Want: corpusPlan{Actions: []corpusAction{itemAction(intent.ActionTurnOn, "flashlight"), action(intent.ActionInspect, "")}}},
